...
public class NotificationsAct extends PermissionsAct {
    ...
    public void sendNotification(View view){
        getPermissionBeforeAction(Manifest.permission.POST_NOTIFICATIONS, this::sendNotification, this::permissionFailed);
    }

    public void timedNotification(View view){
        getPermissionBeforeAction(Manifest.permission.POST_NOTIFICATIONS, this::timedNotification, this::permissionFailed);
    }
